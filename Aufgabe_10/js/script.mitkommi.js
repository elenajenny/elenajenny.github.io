...
for (var index = 0; index < Todosboth.length; index++) {
    console.log(Todosboth[index].name);
}
/**
...
function drawListToDOM() {
    ...
    var _loop_1 = function (index) {
         ...
         */
        todo.innerHTML = "<span class='check " + Todosboth.checked[index] + "'><i class='fas fa-check'></i></span>"
            + Todosboth.text[index] +
    ...
    for (var index = 0; index < Todosboth.text.length; index++) {
        _loop_1(index);
    }
    updateCounter();
}
function updateCounter() {
    counterDOMElement.innerHTML = Todosboth.text.length + " in total";
}
/**
...
function toggleCheckState(index) {
     ...
     */
    Todosboth.checked[index] = !Todosboth.checked[index];
    /**
     * Die zentrale Funktion, um die Liste des ToDo-Arrays in den DOM zu rendern
     * wird wieder getriggert
     */
...
function deleteTodo(index) {
     ...
     */
    Todosboth.text.splice(index, 1);
    Todosboth.checked.splice(index, 1);
    /**
     * Die zentrale Funktion, um die Liste des ToDo-Arrays in den DOM zu rendern
     * wird wieder getriggert
     */
...
//# sourceMappingURL=script.mitkommi.js.map